...
* [*t4n-live.sh*](USAGE.md) - Generator T4n OS ISO
* [*t4n-iso.sh*](USAGE.md) - Script wrapper untuk menghasilkan live image yang dapat di-boot dan digunakan untuk instalasi.
  images for i686, x86_64, and aarch64.
* [*t4n-rootfs.sh*](USAGE.md) - The Void Linux rootfs generator for all platforms
* [*t4n-platformfs.sh*](USAGE.md) - The Void Linux filesystem tool to produce
  a rootfs for a particular platform
* [*t4n-image.sh*](USAGE.md) - The Void Linux image generator for ARM platforms
* [*t4n-net.sh*](USAGE.md) - Script to generate netboot tarballs for Void
...
Untuk menghasilkan ISO live, gunakan [*t4n-iso.sh*](USAGE.md).Untuk menghasilkan ISO live yang lebih dasar(yang tidak menyertakan hal-hal seperti `void-installer`),
gunakan [*t4n-live.sh*](USAGE.md).
...
Use [*t4n-rootfs.sh*](USAGE.md) to generate a Void Linux ROOTFS.
...
[*t4n-platformfs.sh*](USAGE.md) to generate a Void Linux PLATFORMFS.
...
then use [*t4n-image.sh*](USAGE.md) to generate the image.
